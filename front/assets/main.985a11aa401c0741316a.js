!(function (e) {
  function t(t) {
    for (
      var r, l, u = t[0], o = t[1], i = t[2], d = 0, f = [];
      d < u.length;
      d++
    )
      (l = u[d]),
        Object.prototype.hasOwnProperty.call(s, l) && s[l] && f.push(s[l][0]),
        (s[l] = 0);
            ...
            l.default.createElement(
              ...
              l.default.createElement(
                o.Form,
                {
                  ...
                  name: "control-hooks",
                  onFinish: S,
                  initialValues: { wsocketUrl: "localhost:8080" },
                },
                l.default.createElement(
                  o.Form.Item,
            ...
            l.default.createElement(
              ...
              a.reverse().map(function (e, t) {
                return l.default.createElement(
                  ...
                  { key: t },
                  e
                    ? l.default.createElement("div", null, e.data.split(" ")[0])
                    : null
                );
              })
            )
